			...
			If fr\grid[(ty*gridsize)+tx]=1 Then 
				...
				If tile_type > 0 Then 
					...
					If (ty Mod 3)=2 And itemPlaced[Floor(ty/3)]=False Then
						...
						it.Items = CreateItem("Protokoll #"+Int(Floor(ty/3)+1), "paper", 0,0.5,0)
...
;			EntityParent dp\cam,fr\Forest_Pivot
			...
			it = CreateItem("Dokument SCP-860-1", "paper", r\x + 672.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 335.0 * RoomScale)
			RotateEntity it\collider, 0, r\angle+10, 0
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Dokument SCP-860", "paper", r\x + 1152.0 * RoomScale, r\y + 176.0 * RoomScale, r\z - 384.0 * RoomScale)
		...
		Case "roompj"
			;[Block]
			it = CreateItem("Dokument SCP-372", "paper", r\x + 800.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 1108.0 * RoomScale)
		...
		Case "room2storage"
			...
			it = CreateItem("Dokument SCP-939", "paper", r\x + 352.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 256.0 * RoomScale)
		...
		Case "room2sroom"
			...
			it = CreateItem("Etwas SCP-420-J", "420", r\x + 1776.0 * RoomScale, r\y + 400.0 * RoomScale, r\z + 427.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Etwas SCP-420-J", "420", r\x + 1808.0 * RoomScale, r\y + 400.0 * RoomScale, r\z + 435.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			...
			it = CreateItem("Dokument zu Nukleargerät", "paper", r\x + 2248.0 * RoomScale, r\y + 440.0 * RoomScale, r\z + 372.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2poffices"
			...
			it = CreateItem("Rätzelhafte Notiz", "paper", r\x + 736.0 * RoomScale, r\y + 224.0 * RoomScale, r\z + 544.0 * RoomScale)
			EntityParent(it\collider, r\obj)	
			it = CreateItem("Schusssichere Weste", "vest", r\x + 608.0 * RoomScale, r\y + 112.0 * RoomScale, r\z + 32.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			
			it = CreateItem("Vorfallbericht SCP-106-0204", "paper", r\x + 704.0 * RoomScale, r\y + 183.0 * RoomScale, r\z - 576.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			it = CreateItem("Tagebuchseite", "paper", r\x + 912 * RoomScale, r\y + 176.0 * RoomScale, r\z - 160.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2poffices2"
			...
			it = CreateItem("Dr. L's verbrannte Notiz", "paper", r\x - 688.0 * RoomScale, 1.0, r\z - 16.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Dr L's verbrannte Notiz", "paper", r\x - 808.0 * RoomScale, 1.0, r\z - 72.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2nuke"
			...
			it = CreateItem("Dokument zu Nukleargerät", "paper", r\x - 768.0 * RoomScale, r\y + 1684.0 * RoomScale, r\z - 768.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Schusssichere Weste", "vest", r\x - 944.0 * RoomScale, r\y + 1652.0 * RoomScale, r\z - 656.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, -90, 0)
...
;			
			...
			EntityParent(de\obj, r\obj)
			it = CreateItem("Versengte Notiz", "paper", r\x + 64.0 * RoomScale, r\y +144.0 * RoomScale, r\z - 384.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "008"
			;[Block]
			...
			it = CreateItem("Schutzanzug", "hazmatsuit", r\x - 76.0 * RoomScale, 0.5, r\z - 396.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			
			it = CreateItem("Dokument SCP-008", "paper", r\x - 245.0 * RoomScale, r\y + 192.0 * RoomScale, r\z + 368.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room035"
			...
			it = CreateItem("SCP-035 Nachtrag", "paper", r\x + 248.0 * RoomScale, r\y + 220.0 * RoomScale, r\z + 576.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			...
			it = CreateItem("Dokument SCP-035", "paper", r\x + 1168.0 * RoomScale, 104.0 * RoomScale, r\z + 608.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room513"
			;[Block]
			...
			it = CreateItem("Blutverschmierte Notiz", "paper", r\x + 736.0 * RoomScale,1.0, r\z + 48.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Dokument SCP-513", "paper", r\x - 480.0 * RoomScale, 104.0*RoomScale, r\z - 176.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room966"
			;[Block]
		...
		Case "room049"
			...
			it = CreateItem("Dokument SCP-049", "paper", r\x - 608.0 * RoomScale, r\y - 3332.0 * RoomScale, r\z + 876.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room012"
			...
			it = CreateItem("Dokument SCP-012", "paper", r\x - 56.0 * RoomScale, r\y - 576.0 * RoomScale, r\z - 408.0 * RoomScale)
			EntityParent(it\collider, r\obj)
...
;			PositionEntity(r\Objects[6], r\x - 848*RoomScale, 0.5, r\z-576*RoomScale, True)
		...
		Case "room3servers2"
			...
			it = CreateItem("Dokument SCP-970", "paper", r\x + 960.0 * RoomScale, r\y - 448.0 * RoomScale, r\z + 251.0 * RoomScale)
			RotateEntity it\collider, 0, r\angle, 0
			EntityParent(it\collider, r\obj)		
		...
		Case "testroom"
			...
			it = CreateItem("Dokument SCP-682", "paper", r\x + 656.0 * RoomScale, r\y - 1200.0 * RoomScale, r\z - 16.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2closets"
			;[Block]
			it = CreateItem("Dokument SCP-1048", "paper", r\x + 736.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 736.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			...
			it = CreateItem("Vorfallbericht SCP-1048-A", "paper",r\x + 736.0 * RoomScale, r\y + 224.0 * RoomScale, r\z -480.0 * RoomScale)
		...
		Case "room2offices"
			;[Block]
			it = CreateItem("Dokument SCP-106", "paper", r\x + 404.0 * RoomScale, r\y + 145.0 * RoomScale, r\z + 559.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			...
			it = CreateItem("Mitteilung", "paper", r\x -137.0 * RoomScale, r\y + 153.0 * RoomScale, r\z + 464.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2offices2"
			...
			it = CreateItem("Dokument SCP-895", "paper", r\x - 800.0 * RoomScale, r\y - 48.0 * RoomScale, r\z + 368.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			If Rand(2) = 1 Then
				it = CreateItem("Dokument SCP-860", "paper", r\x - 800.0 * RoomScale, r\y - 48.0 * RoomScale, r\z - 464.0 * RoomScale)
			Else
				it = CreateItem("SCP-093 Geborgene Materialien", "paper", r\x - 800.0 * RoomScale, r\y - 48.0 * RoomScale, r\z - 464.0 * RoomScale)
			EndIf
			EntityParent(it\collider, r\obj)
		...
		Case "room2offices3"
			;[Block]
			If Rand(2)=1 Then 
				it = CreateItem("Mobile Einsatztruppen", "paper", r\x + 744.0 * RoomScale, r\y +240.0 * RoomScale, r\z + 944.0 * RoomScale)
				EntityParent(it\collider, r\obj)	
			Else
				it = CreateItem("Sicherheitsfreigabestufen", "paper", r\x + 680.0 * RoomScale, r\y +240.0 * RoomScale, r\z + 944.0 * RoomScale)
				EntityParent(it\collider, r\obj)			
			EndIf
			
			it = CreateItem("Objektklassen", "paper", r\x + 160.0 * RoomScale, r\y +240.0 * RoomScale, r\z + 568.0 * RoomScale)
			EntityParent(it\collider, r\obj)	
			
			it = CreateItem("Dokument", "paper", r\x -1440.0 * RoomScale, r\y +624.0 * RoomScale, r\z + 152.0 * RoomScale)
			EntityParent(it\collider, r\obj)	
		...
		Case "room2scps"
			...
			it = CreateItem("Dokument SCP-714", "paper", r\x - 728.0 * RoomScale, r\y + 288.0 * RoomScale, r\z - 360.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Dokument SCP-427", "paper", r\x - 608.0 * RoomScale, r\y + 66.0 * RoomScale, r\z + 636.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "coffin"
			...
			it = CreateItem("Dokument SCP-895", "paper", r\x - 688.0 * RoomScale, r\y + 133.0 * RoomScale, r\z - 304.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "914"
			...
			it = CreateItem("Nachtrag: 5/14 Test Log", "paper", r\x +954.0 * RoomScale, r\y +228.0 * RoomScale, r\z + 127.0 * RoomScale)
			EntityParent(it\collider, r\obj)	
			
			it = CreateItem("First Aid Kit", "firstaid", r\x + 960.0 * RoomScale, r\y + 112.0 * RoomScale, r\z - 40.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			
			it = CreateItem("Dr. L's Notiz", "paper", r\x - 928.0 * RoomScale, 160.0 * RoomScale, r\z - 160.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "173"
			;[Block]
			...
			CreateItem("Orientierungsbroschüre für Klasse D", "paper", r\x-(2914+1024)*RoomScale, 170.0*RoomScale, r\z+40*RoomScale)
		...
		Case "room2ccont"
			...
			it = CreateItem("Notiz von Daniel", "paper", r\x-400.0*RoomScale,1040.0*RoomScale,r\z+115.0*RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room106"
			...
			it = CreateItem("Dr. Allok's Notiz", "paper", r\x - 416.0 * RoomScale, r\y - 576 * RoomScale, r\z + 2492.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Rückrufprotokoll RP-106-N", "paper", r\x + 268.0 * RoomScale, r\y - 576 * RoomScale, r\z + 2593.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2test1074"
			...
			it = CreateItem("Dokument SCP-1074","paper",r\x + 300.0 * RoomScale,r\y+20.0*RoomScale,r\z + 671.0*RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room1123"
			;[Block]
			it = CreateItem("Dokument SCP-1123", "paper", r\x + 511.0 * RoomScale, r\y + 125.0 * RoomScale, r\z - 936.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-1123", "1123", r\x + 832.0 * RoomScale, r\y + 166.0 * RoomScale, r\z + 784.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Broschüre", "paper", r\x - 816.0 * RoomScale, r\y + 704.0 * RoomScale, r\z+ 888.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "pocketdimension"
			...
			CreateItem("Verbrannte Notiz", "paper", EntityX(r\obj),0.5,EntityZ(r\obj)+3.5)
		...
		Case "room1162"
			...
			it = CreateItem("Dokument SCP-1162", "paper", r\x + 863.227 * RoomScale, r\y + 152.0 * RoomScale, r\z - 953.231 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2scps2"
			...
			it = CreateItem("Dokument SCP-1499", "paper", r\x + 840.0 * RoomScale, r\y + 260.0 * RoomScale, r\z + 224.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Dokument SCP-500", "paper", r\x + 1152.0 * RoomScale, r\y + 224.0 * RoomScale, r\z + 336.0 * RoomScale)
			EntityParent(it\collider, r\obj)
...
;			RotateEntity r\Objects[21],8.6,-150.0,-5.0
		...
		Case "room2cpit"
			...
			it = CreateItem("Dr L's Notiz", "paper", r\x - 160.0 * RoomScale, 32.0 * RoomScale, r\z - 353.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "dimension1499"
			;[Block]
